...
\date[21.12.16 г. -- 11.01.17 г.]{21 декември 2016 г. -- 11 януари 2017 г.}
...
\newcommand{\go}[1]{\temporal<#1>{}\hero\step}
\newcommand{\gor}[1]{\temporal<#1>{}\hero\rstep}
\newcommand{\goback}[2]{\temporal<#1>{}\hero{\alt<#2>\hero\step}}
\newcommand{\gobackr}[2]{\temporal<#1>{}\hero{\temporal<#2>\step\hero\rstep}}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[visible on=<18>] at (a-3-5.center) {\hero};
    \end{tikzpicture}
  \end{center}
\end{frame}
